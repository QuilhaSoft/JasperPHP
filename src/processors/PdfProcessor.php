...
class PdfProcessor
{
    ...
    public static function getInstance(\JasperPHP\elements\Report $jasperObj = null)
    {
        if (self::$instance === null) {
            self::$instance = new self($jasperObj);
        }
        if ($jasperObj !== null) {
            self::$instance->jasperObj = $jasperObj;
        }
    ...
    {
        $instance = self::getInstance($report);
