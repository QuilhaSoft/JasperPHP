...
class TextField extends Element {
    ...
    public function generate() {
        ...
        if (isset($data->hyperlinkReferenceExpression)) {
            $data->hyperlinkReferenceExpression = $reportInstance->get_expression($data->hyperlinkReferenceExpression,$rowData,false,$this);
        }
        $multiCell = false;
        ...
        $reportInstance->applyStyle($name, $data->reportElement, $rowData);
        }
        ...
        switch ($this->objElement->textFieldExpression) {
            ...
            case 'new java.util.Date()':
                ...
                break;
            default:
                $text = $reportInstance->get_expression($text,$rowData,$writeHTML,$this);
...
//                }
        ...
        $printWhenExpression = $reportInstance->get_expression($data->reportElement->printWhenExpression, $rowData);
